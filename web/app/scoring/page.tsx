    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="bg-white p-6 shadow rounded">
        ...
        <p className="text-gray-600 mb-6">
          Trigger the backend machine learning inference script. The script will
          generate predictions for unfulfilled orders and update the database,
          which directly populates the Late Delivery Priority Queue.
        </p>
      ...
      {result && (
        <div
          className={`p-6 shadow rounded border ${result.success ? "bg-green-50 border-green-200" : "bg-red-50 border-red-200"}`}
        >
          <h2
            className={`text-lg font-bold mb-2 ${result.success ? "text-green-800" : "text-red-800"}`}
          >
